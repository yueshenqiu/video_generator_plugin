...
# 可灵 Kling 能力声明
KLING_CAPABILITIES = ProviderCapabilities(
    provider_name="kling",
    display_name="可灵 Kling",
    supports_cancel=False,
    models={
        "kling-v1-6": ModelCapabilities(
            model_id="kling-v1-6",
            display_name="可灵 1.6",
            video_features=[
                VideoFeature.TEXT_TO_VIDEO,
            ...
            fps=FpsSupport(allowed_values=[24, 30], default=24),
        ),
        "kling-v2-6": ModelCapabilities(
            model_id="kling-v2-6",
            display_name="可灵 2.6",
            video_features=[
                VideoFeature.TEXT_TO_VIDEO,
